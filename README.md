...
Você vai desenvolver sua primeira API utilizando a arquitetura MSC (model-service-controller)! <br> <br>
...
1. Clone o repositório com o comando: `git clone git@github.com:aimemartins/project-store-manager.git`
2. Entre na pasta do repositório que você acabou de clonar: `cd project-store-manager`
...
Para orientar a manipulação das tabelas, utilize o DER a seguir:![DER](./public/erStoreManager.png)
